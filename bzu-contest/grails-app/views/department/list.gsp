			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="no" title="${message(code: 'department.no.label', default: 'No')}" />
						...
						<g:sortableColumn property="category" title="${message(code: 'department.category.label', default: 'Category')}" />
				...
				<g:each in="${departmentInstanceList}" status="i" var="departmentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${departmentInstance.id}">${fieldValue(bean: departmentInstance, field: "no")}</g:link></td>
