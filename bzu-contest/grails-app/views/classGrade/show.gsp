			...
			<ol class="property-list classGrade">
				...
				<li class="fieldcontain">
					<span id="specialty-label" class="property-label"><g:message code="classGrade.specialty.label" default="Specialty" /></span>
						...
						<span class="property-value" aria-labelledby="specialty-label"><g:link controller="specialty" action="show" id="${classGradeInstance?.specialty?.id}">${classGradeInstance?.specialty?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="grade-label" class="property-label"><g:message code="classGrade.grade.label" default="Grade" /></span>
						...
						<span class="property-value" aria-labelledby="grade-label">${classGradeInstance.grade}</span>
